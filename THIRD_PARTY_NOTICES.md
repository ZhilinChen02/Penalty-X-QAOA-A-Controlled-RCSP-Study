...
Original project code is licensed under MIT, copyright 2026 Zhilin Chen.
This does not relicense third-party components.

## Plot fonts

The PDF figures embed subsets of STIXGeneral and STIXNonUnicode supplied by
Matplotlib. They retain the STIX/SIL Open Font License notice reproduced below.
The plots themselves are project-generated scientific figures. No standalone
font files are bundled. NumPy, SciPy, pandas, Matplotlib, PyYAML and optional
testing/GPU packages are installed separately under their upstream licenses.

## Templates and data

No Springer LaTeX class/style, third-party manuscript template, downloaded
paper, external image or third-party dataset is bundled in the current tree.
Benchmark instances are synthetic and generated by project code. No vendored
external implementation was identified in the retained source tree.

## STIX notice supplied with Matplotlib
